...
import { Label } from "@faroukprog69/ui/components/label";
import { Separator } from "@faroukprog69/ui/components/separator";
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      {...props}
    >
      <Separator className="bg-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px absolute inset-0 top-1/2" />
      {children && (
        <span
